...
<td>
        <form>
                Approve<input type="radio" name="Approve" onchange="handleChange(this);" id='<?php echo $row['id'];?>' value="Approve" />
                Pending<input type="radio" name="Pending" onchange="handleChange(this);" id='<?php echo $row['id'];?>' value="Pending" />
        </form>
